...
RSpec.describe AffiliateController, type: :controller do
  ...
  # As you add validations to Affiliate, be sure to adjust the attributes here as well.
  ...
  describe "GET #show" do
    it "assigns the requested affiliate as @affiliate" do
      affiliate = Affiliate.create! valid_attributes
      get :show, params: {id: affiliate.to_param}, session: valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested affiliate as @affiliate" do
      affiliate = Affiliate.create! valid_attributes
      get :edit, params: {id: affiliate.to_param}, session: valid_session
      expect(assigns(:affiliate)).to eq(affiliate)
    end
  end
